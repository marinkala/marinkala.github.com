...
Half-page <span style="color:orange">single-spaced</span> [reflection](reflections.md) on the readings is <span style="color:orange">due Wed, 8/22 by 5PM</span>  by email
...
One-page <span style="color:orange">single-spaced</span> [reflection](reflections.md) on <span style="color:orange">all</span> the week's readings is <span style="color:orange">due Mon, 8/27 by 5PM</span>  by email
...
* [Paul S. Earle, Daniel C. Bowden, Michelle Guy (2012). Twitter Earthquake Detection: Earthquake Monitoring in a Social World](http://www.annalsofgeophysics.eu/index.php/annals/article/view/5364), *Annals of Geophysics*, 54(6).
...
* [Hollan, J., Hutchins, E., Kirsh, D. (2000). Distributed Cognition: Toward a New Foundation for Human-Computer Interaction Research](https://wiki.sfu.ca/spring10/iat832g100/images/5/51/Distributed_cognition.pdf), *ACM Transactions on Computer-Human Interaction*, 7(2), 174-196.
...
One-page <span style="color:orange">single-spaced</span> [reflection](reflections.md) on <span style="color:orange">all</span> the week's readings is <span style="color:orange">due Mon, 9/03 by 5PM</span>  by email
...
* [K. Luther, C. Fiesler, and A. Bruckman. Redistributing Leadership in Online Creative Collaboration](http://kurtluther.com/pdf/luther_redistributing_leadership_cscw2013.pdf), *ACM Conference on Computer Supported Cooperative Work (CSCW 2013)*, San Antonio, Tx., USA, 2013.
...
**<span style="color:grey">In-class Network Activity</span>**
...
One-page <span style="color:orange">single-spaced</span> [reflection](reflections.md) on <span style="color:orange">all</span> the week's readings is <span style="color:orange">due Mon, 9/17 by 5PM</span>  by email
...
One-page <span style="color:orange">single-spaced</span> [reflection](reflections.md) on <span style="color:orange">all</span> the week's readings is <span style="color:orange">due Mon, 9/24 by 5PM</span>  by email
...
* [Parks, M. R. (2017). Embracing the challenges and opportunities of mixed-media relationships](https://onlinelibrary.wiley.com/doi/abs/10.1111/hcre.12125), *Human Communication Research*, 43(4), 505-517.

One-page <span style="color:orange">single-spaced</span> [reflection](reflections.md) on <span style="color:orange">all</span> the week's readings is <span style="color:orange">due Mon, 10/01 by 5PM</span>  by email
...
One-page <span style="color:orange">single-spaced</span> [reflection](reflections.md) on <span style="color:orange">all</span> the week's readings is <span style="color:orange">due Mon, 10/15 by 5PM</span>  by email
...
One-page <span style="color:orange">single-spaced</span> [reflection](reflections.md) on <span style="color:orange">all</span> the week's readings is <span style="color:orange">due Mon, 10/22 by 5PM</span>  by email
...
One-page <span style="color:orange">single-spaced</span> [reflection](reflections.md) on <span style="color:orange">all</span> the week's readings is <span style="color:orange">due Mon, 10/29 by 5PM</span>  by email
...
* [Hargittai, E. (2018).  Potential Biases in Big Data: Omitted Voices on Social Media](http://journals.sagepub.com/doi/abs/10.1177/0894439318788322?journalCode=ssce), *Social Science Computer Review*

One-page <span style="color:orange">single-spaced</span> [reflection](reflections.md) on <span style="color:orange">all</span> the week's readings is <span style="color:orange">due Mon, 11/12 by 5PM</span>  by email
...
**<span style="color:grey">Crowd-Sourced Methodological Lecture</span>**
...
**<span style="color:grey">Crowd-sourced Grad-student-led Discussion 1</span>**

No reflection.

**<span style="color:grey">WEEK 15. Thursday (November 29)</span>**

**<span style="color:grey">Crowd-sourced Grad-student-led Discussion 2</span>**

No reflection.

**<span style="color:grey">WEEK 16. Tuesday (December 4)</span>**

**<span style="color:grey">Crowd-sourced Grad-student-led Discussion 3</span>**

No reflection.

**<span style="color:grey">WEEK 16. Thursday (December 6)</span>**

**<span style="color:grey">Crowd-sourced Grad-student-led Discussion 4</span>**
