...
Half-page <span style="color:orange">single-spaced</span> reflection on the readings is <span style="color:orange">due Wed, 8/22 by 5PM</span>  by email
...
One-page <span style="color:orange">single-spaced</span> reflection on the week's readings is <span style="color:orange">due Mon, 8/27 by 5PM</span>  by email
...
One-page <span style="color:orange">single-spaced</span> reflection on the week's readings is <span style="color:orange">due Mon, 9/03 by 5PM</span>  by email
...
* [K. Luther, C. Fiesler, and A. Bruckman. Redistributing Leadership in Online Creative Collaboration. A](http://kurtluther.com/pdf/luther_redistributing_leadership_cscw2013.pdf), *ACM Conference on Computer Supported Cooperative Work (CSCW 2013)*, San Antonio, Tx., USA, 2013.
...
One-page <span style="color:orange">single-spaced</span> reflection on the week's readings is <span style="color:orange">due Mon, 9/17 by 5PM</span>  by email
**<span style="color:grey">WEEK 5. Thursday (September 20)</span>**

**<span style="color:grey">Social Media in Crisis </span>**

* [Starbird, Kate and Leysia Palen (2011). “Voluntweeters:” Self-Organizing by Digital Volunteers in Times of Crisis. ACM 2011 Conference on Computer Human Interaction (CHI 2011), Vancouver, BC, Canada.](https://www.cs.colorado.edu/~palen/voluntweetersStarbirdPalen.pdf), *ACM 2011 Conference on Computer Human Interaction (CHI 2011)*, Vancouver, BC, Canada.
...
One-page <span style="color:orange">single-spaced</span> reflection on the week's readings is <span style="color:orange">due Mon, 9/24 by 5PM</span>  by email
...
One-page <span style="color:orange">single-spaced</span> reflection on the week's readings is <span style="color:orange">due Mon, 10/01 by 5PM</span>  by email
...
One-page <span style="color:orange">single-spaced</span> reflection on the week's readings is <span style="color:orange">due Mon, 10/15 by 5PM</span>  by email
...
One-page <span style="color:orange">single-spaced</span> reflection on the week's readings is <span style="color:orange">due Mon, 10/22 by 5PM</span>  by email
...
One-page <span style="color:orange">single-spaced</span> reflection on the week's readings is <span style="color:orange">due Mon, 10/29 by 5PM</span>  by email
...
One-page <span style="color:orange">single-spaced</span> reflection on the week's readings is <span style="color:orange">due Mon, 11/12 by 5PM</span>  by email
...
**<span style="color:grey">Final Methodological Lecture</span>**
